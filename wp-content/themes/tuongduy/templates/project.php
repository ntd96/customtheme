        ...
        <div class="container-xxl py-5">
            <div class="container px-lg-5">
                ...
                <div class="row mt-n2 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="col-12 text-center">
                        <ul class="list-inline mb-5" id="portfolio-flters">
                            ...
                            <li class="btn px-3 pe-4" data-filter=".sechond">Development</li>
                        </ul>
                    </div>
                </div>
                <div class="row g-4 portfolio-container">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item sechond wow zoomIn" data-wow-delay="0.3s">
                        <div class="position-relative rounded overflow-hidden">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item sechond wow zoomIn" data-wow-delay="0.1s">
                        <div class="position-relative rounded overflow-hidden">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item sechond wow zoomIn" data-wow-delay="0.6s">
                        <div class="position-relative rounded overflow-hidden">
